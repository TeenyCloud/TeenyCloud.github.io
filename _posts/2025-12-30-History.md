...
tags:
image: assets/images/Gemini_Generated_Image_4q0of04q0of04q0o.jpg
image-ai: Gemini
---
...
The operating systems for microcomputers were generally quite primitive compared to UNIX, because the machines themselves were very limited. They were single-user, single-tasking operating systems. However, for microcomputer users, these limitations were acceptable—most users had no frame of reference for anything better. In the late 1970s, the most popular operating system for microcomputers was CP/M by Digital Research Inc, inspired by DEC's TOPS-10 and RT-11 (for the PDP-10 and PDP-11 respectively). This operating system laid the foundation for the entire PC industry. Its legacy can be found in all modern versions of Windows to this day (drive letters like C:) sitting atop the architectural legacy derived from DEC's VMS via the Windows NT kernel.

Even though Microcomputer operating systems of the time were limited, there was one notable exception: a UNIX version was developed for the 16-bit microcomputer market and licensed to OEMs by Microsoft. This version of UNIX, called Xenix, still required a license from AT&T. However, Xenix was mostly available for PC-incompatible microcomputers (such as the Zilog Z8000 and Altos Computer).

In 1981, when IBM was looking for an operating system for its PC, licensing negotiations with Digital Research Inc to use CP/M failed, and IBM turned to Microsoft instead. Because Xenix could not run on the IBM PC's hardware and Microsoft had no other operating system available, they acquired 86-DOS from Seattle Computer Products (SCP). Originally developed as a CP/M clone called QDOS (Quick and Dirty Operating System), 86-DOS mirrored CP/M's API and interface. Microsoft renamed it MS-DOS and licensed it for a flat fee to IBM, who branded it PC-DOS. It was the only operating system available on the PC at launch.
...
<figure class="img-centered">
  <img src="/assets/images/linux-history.jpg" alt="Linux History" style="width: 50%;">
  <figcaption>Generated with Perplexity</figcaption>
</figure>
...
Linux had momentum in 1995 but two major waves made it the dominant OS for Internet infrastructure. First, the Apache web server was launched in 1995 to replace NCSA HTTPd and quickly became the most popular web server of the late '90s. With day-one support for Linux, Apache and Linux provided an accessible, cost-effective platform to host websites. UNIX-based alternatives existed but they were significantly more expensive and confined to large corporations. As the web boomed, Linux and Apache became the foundation of modern internet architecture and this pairing was later formalized as the LAMP stack (Linux, Apache, MySQL, PHP/Perl/Python). As Linux continued to evolve and close the gap with enterprise Unix systems, it became the de facto standard for web servers.
The second wave secured Linux's position in the data center. Beginning with Oracle in 1998, major enterprise software vendors began treating Linux as a first-class citizen. In 1999, IBM released DB2 on Linux, SAP brought its ERP suite to Linux, and both Sybase and Informix ported their RDBMS to Linux. BEA Systems followed in 2000 with WebLogic. Finally, in 2001, IBM committed $1 billion to Linux development: they ported all their software and middleware including WebSphere, signaling Linux was becoming a serious contender for mission-critical enterprise workloads. This was a pivotal moment for Linux. It turned it from a niche hobbyist OS into an indispensable global enterprise standard.

In the end, a unique conjunction of events made Linux possible. The commercial UNIX market was heavily fragmented (the infamous UNIX wars) while licensing and hardware costs were prohibitively expensive, making it impractical for personal computers. IBM PCs were constrained by the limitations of MS-DOS and early Windows. The only affordable alternative, BSD, was under heavy legal scrutiny and entangled in a lawsuit, creating a risk for enterprise adoption. The market needed an open standard. Meanwhile, the GNU project had laid the groundwork to build a UNIX-like operating system, with only a kernel missing. When the commercial internet and web boom arrived, businesses were in desperate need of a high-performance, cost-effective infrastructure platform. Linus Torvalds not only provided the missing piece, but his decision to release it under the GPL and to pioneer an open-source development model over the Internet was visionary and disrupted the traditional software industry. The ultimate enterprise validation followed: major software vendors like Oracle, SAP and IBM ported their mission-critical databases and middleware to Linux. Over time, virtually every major tech company contributed to Linux: Google, Intel, AMD, Amazon, Facebook and even Microsoft to name a few. All of this contributed to making Linux the foundation of modern computing.
